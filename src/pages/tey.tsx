    ...
    <div className="relative z-10 h-full flex flex-col p-8">
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="text-3xl font-bold tracking-tight mb-1 flex items-center">
            <span className="bg-gradient-to-r from-purple-700 via-purple-600 to-purple-700 bg-clip-text text-transparent">CAP 360</span>
            <Sparkles className="w-6 h-6 ml-2 text-yellow-500" />
          </div>
          <div className="text-xs font-bold tracking-widest text-gray-700 uppercase">Career Transformation</div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center space-y-6">
        <div className="space-y-4">
          <div className="inline-block px-4 py-1.5 rounded-full bg-gradient-to-r from-yellow-400 to-amber-400 border-2 border-yellow-500/30 text-sm font-bold shadow-lg">
            ...
            {stats.map((stat, idx) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-sm text-gray-800 leading-snug font-bold">{stat.label}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 rounded-2xl p-6 border-2 border-purple-500 shadow-2xl overflow-hidden">
          ...
          <p className="text-xl md:text-2xl font-black text-center relative z-10 leading-snug text-white drop-shadow-lg">
            "{tagline}"
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t-2 border-gray-200 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div className="text-sm font-bold text-gray-800">Join 1000+ Professionals</div>
        </div>
        <div className="flex items-center space-x-2">
          <div className="w-2.5 h-2.5 rounded-full bg-yellow-400 animate-pulse shadow-lg shadow-yellow-400/50"></div>
          <span className="text-sm font-bold text-purple-700">Transform Today</span>
        </div>
      </div>
    </div>
...
const posts = [
  {
    ...
    stats: [
      { value: "10+", label: "Years of Elite Connections" },
      { value: "Direct", label: "HR & CXO Access" },
      { value: "Multi", label: "Industry Coverage" },
      { value: "Fast", label: "Track Your Career" }
    ]
  },
  {
    ...
    stats: [
      ...
      { value: "Smart", label: "Position Validation" },
      { value: "Perfect", label: "Timing Intelligence" },
  ...
  },
  {
    ...
    stats: [
      { value: "Expand", label: "Market Reach Exponentially" },
      { value: "Grow", label: "Elite Network Access" },
      { value: "Stand Out", label: "In Your Industry" },
      { value: "Lead", label: "Your Success Story" }
    ]
  },
  {
    title: "Applications Made Effortless",
    subtitle: "Focus on strategy, we handle the rest",
    tagline: "Work smarter, not harder",
    icon: Zap,
    accentGradient: "bg-gradient-to-br from-yellow-600 to-amber-600",
    stats: [
      { value: "Save", label: "Valuable Time & Energy" },
      { value: "Get", label: "Expert Application Support" },
      { value: "Focus", label: "On What Truly Matters" },
      { value: "Achieve", label: "Superior Outcomes" }
    ]
  },
  {
    title: "Your Career Catalyst",
    subtitle: "A decade of connections opening doors",
    tagline: "Experience that accelerates success",
    icon: Network,
    accentGradient: "bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800",
    stats: [
      { value: "10+", label: "Years Building Networks" },
      { value: "Various", label: "Industries Served" },
      { value: "Top", label: "Executive Level Reach" },
      { value: "Proven", label: "Career Acceleration" }
    ]
  }
];
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-purple-200 shadow-xl">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border-2 border-purple-200">
                <p className="text-sm text-gray-600 mb-1 font-bold">Optimized For</p>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-4 border-2 border-yellow-200">
                <p className="text-sm text-gray-600 mb-1 font-bold">Theme</p>
                <p className="font-black text-gray-900">
